...
var imageURL string = "https://www.googleapis.com/compute/v1/projects/debian-cloud/global/images/debian-7-wheezy-v20140606"
var someDescription string = "compute sample instance"
...
func DeleteInstance(instanceName string) {
	...
	inst, err := computeService.Instances.Get("eleanor-270008", "us-west1-c", instanceName).Do()
